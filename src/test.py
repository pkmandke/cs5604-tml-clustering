...
SAVE_PATH = '../obj/tobacco/doc2vec/unittest_Doc2vec_wrapper_'
...
def main()
    ...
    doc2vec_model = Doc2vec_wrapper(tb_path=TB_PATH, n_docs=10)
    
    doc2vec_model.generate_tokens()
    
    doc2vec_model.load_model_and_build_vocab(vector_size=128, dm=1, dm_mean=1, dbow_words=0, epochs=2, workers=10, min_count=2)
